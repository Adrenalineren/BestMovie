...
async function seed() {
  ...
  const movieData = [
    ...
    { title: 'Wuthering Heights', 
      duration: 105, 
      cast: ['Kaya Scodelario', 'Tom Hardy', 'Elliot Page'],
    ...
    { title: 'Kiki\'s Delivery Service', 
      duration: 95, 
      cast: ['Minami Takayama', 'Mari Natsuki', 'Akemi Okamura'],
    ...
    { title: 'Marty Supreme', 
      duration: 85,  
      cast: ['Timothee Chalamet', 'Tyler the Creator'],
      director: 'John Doe',
      language: 'English',
      ageRating: 'R21', 
      rating: 7.0, 
