...
async function seed() {
  ...
  add(screening(0, 0, 0, nowMins - 40));   // Interstellar Odyssey — Hall 1
  add(screening(3, 3, 0, nowMins - 20));   // Crimson Tide Rising — Hall 4

  // TODAY — upcoming: starting in +2h and +4h
  add(screening(1, 1, 0, nowMins + 120));  // Shadow of the Dragon — Hall 2
  add(screening(2, 2, 0, nowMins + 120));  // The Last Laugh — Hall 3
  add(screening(4, 0, 0, nowMins + 240));  // Neon Dreams — Hall 1 (after playing one ends)
  add(screening(5, 1, 0, nowMins + 300));  // Wildflower — Hall 2
